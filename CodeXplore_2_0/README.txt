This package will help spotting the occurrences of any C++ banned functions in a code repository. The identified C++ banned functions are displayed in a tabular form along with their locations in the code and their secure alternatives.
...
Note: you're absolutely free to edit, copy, or customize the code according to your need. The Security Team is not going to maintain this in the future. 
